...
public class Main {
    public static void main(String[] args) {
        ...
        String[] shipNames = {"Carrier - C - 5", "Battleship - B - 4", "Cruiser - R - 3", "Submarine - S - 2", "Destroyer - D - 1"};
        int x = 0;
        int y = 0;
        int orientation;
        ...
        for (int i = 0; i < 5; i++) {
            ...
            while (!board.fitShip(ships.get(i), x, y, orientation)) {
            ...
            board.placeShip(ships.get(i), x, y, orientation);
            board.printBoard();
        }
        ...
        if (winner){
            ...
            if (turn < Integer.parseInt(Tiedosto.lueEnnatys())) {
